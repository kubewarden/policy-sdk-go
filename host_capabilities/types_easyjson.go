...
func easyjson6601e8cdDecodeGithubComKubewardenPolicySdkGoHostCapabilities5(in *jlexer.Lexer, out *KeylessInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6601e8cdEncodeGithubComKubewardenPolicySdkGoHostCapabilities5(out *jwriter.Writer, in KeylessInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
