...
func easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV1(in *jlexer.Lexer, out *CSIPersistentVolumeSource) {
	...
	for !in.IsDelim('}') {
		...
		case "controllerExpandSecretRef":
			if in.IsNull() {
				in.Skip()
				out.ControllerExpandSecretRef = nil
			} else {
				if out.ControllerExpandSecretRef == nil {
					out.ControllerExpandSecretRef = new(SecretReference)
				}
				easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.ControllerExpandSecretRef)
			}
		case "controllerPublishSecretRef":
			if in.IsNull() {
				...
				easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.ControllerPublishSecretRef)
			}
		case "driver":
			if in.IsNull() {
				in.Skip()
		...
		case "nodePublishSecretRef":
			if in.IsNull() {
				...
				easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.NodePublishSecretRef)
			}
		case "nodeStageSecretRef":
			if in.IsNull() {
				...
				easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, out.NodeStageSecretRef)
			}
		case "readOnly":
...
func easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in CSIPersistentVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ControllerExpandSecretRef != nil {
		const prefix string = ",\"controllerExpandSecretRef\":"
		first = false
		out.RawString(prefix[1:])
		easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.ControllerExpandSecretRef)
	}
	if in.ControllerPublishSecretRef != nil {
		...
		easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.ControllerPublishSecretRef)
	}
	{
	...
	if in.NodePublishSecretRef != nil {
		...
		out.RawString(prefix)
		easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.NodePublishSecretRef)
	}
	if in.NodeStageSecretRef != nil {
		const prefix string = ",\"nodeStageSecretRef\":"
		out.RawString(prefix)
		easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *in.NodeStageSecretRef)
	}
	if in.ReadOnly {
...
func (v CSIPersistentVolumeSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV1(&w, v)
...
func (v *CSIPersistentVolumeSource) UnmarshalJSON(data []byte) error {
	...
	easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CSIPersistentVolumeSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV1(l, v)
}
func easyjson9787651aDecodeGithubComKubewardenK8sObjectsApiCoreV11(in *jlexer.Lexer, out *SecretReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9787651aEncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in SecretReference) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
